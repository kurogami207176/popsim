...
public class BaseFeatures {
    ...
    public static Satiaty BASE_SATIATY = new Satiaty(0.8f, 2f,30f, 70f, 70f);
    public static Supplier<Body> BASE_BODY = () -> new Body(1, BASE_HEALTH.get());

    public static Mind BASE_MIND = new Mind(5, 2);
    ...
    public static Reproduction BASE_SHORT_RANGE_REPRODUCTION = new Reproduction(20, 1, 2, 10, 0.01f);
    public static Reproduction BASE_LONG_RANGE_REPRODUCTION = new Reproduction(10, 2,5, 100, 0.1f);
